...
class MS_Init_ImportProcess():
    ...
    def CreateTextureNode(self, textureType, PosX, PosY, colorspace = 1, connectToMaterial = False, materialInputIndex = 0):
        ...
        textureNode.image.colorspace_settings.name = self.colorSpaces[colorspace] # "sRGB", "Non-Color"
...
def menu_func_import(self, context):
    self.layout.operator(MS_Init_LiveLink.bl_idname, text="Megascans Plugin")
